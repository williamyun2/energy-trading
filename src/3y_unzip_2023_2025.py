...
print("=" * 70)
print("Unzip and Process Load Forecast Archives - PART 2 (2023-2025)")
print("=" * 70)

INPUT_DIR = Path(r"C:\code\energy_trading\input_data\load\SevenDay_Load_Forecast_by_Model_and_Weather_Zone_part2")
